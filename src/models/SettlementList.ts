...
/**
 * Check if a given object implements the SettlementList interface.
 */
export function instanceOfSettlementList(value: object): value is SettlementList {
    return true;
}

export function SettlementListFromJSON(json: any): SettlementList {
    return SettlementListFromJSONTyped(json, false);
}

export function SettlementListFromJSONTyped(json: any, ignoreDiscriminator: boolean): SettlementList {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(SettlementFromJSON)),
        'pagination': json['pagination'] == null ? undefined : PaginationMetaFromJSON(json['pagination']),
    };
}

export function SettlementListToJSON(json: any): SettlementList {
    return SettlementListToJSONTyped(json, false);
}

export function SettlementListToJSONTyped(value?: SettlementList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(SettlementToJSON)),
