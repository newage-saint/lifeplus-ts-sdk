 ...
 * 
 * @export
 * @interface SettlementDetailBreakdownByType
 */
export interface SettlementDetailBreakdownByType {
    /**
     * 
     * @type {number}
     * @memberof SettlementDetailBreakdownByType
     */
    clicks?: number;
    /**
     * 
...
/**
 * Check if a given object implements the SettlementDetailBreakdownByType interface.
 */
export function instanceOfSettlementDetailBreakdownByType(value: object): value is SettlementDetailBreakdownByType {
    return true;
}

export function SettlementDetailBreakdownByTypeFromJSON(json: any): SettlementDetailBreakdownByType {
    return SettlementDetailBreakdownByTypeFromJSONTyped(json, false);
}

export function SettlementDetailBreakdownByTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): SettlementDetailBreakdownByType {
    if (json == null) {
        return json;
    }
    return {
        ...
        'appointment': json['appointment'] == null ? undefined : json['appointment'],
        'diagnostic': json['diagnostic'] == null ? undefined : json['diagnostic'],
        '_package': json['package'] == null ? undefined : json['package'],
    };
}

export function SettlementDetailBreakdownByTypeToJSON(json: any): SettlementDetailBreakdownByType {
    return SettlementDetailBreakdownByTypeToJSONTyped(json, false);
}

export function SettlementDetailBreakdownByTypeToJSONTyped(value?: SettlementDetailBreakdownByType | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
