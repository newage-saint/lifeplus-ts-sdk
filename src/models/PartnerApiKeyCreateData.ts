...
import type { PartnerApiKeyCreateDataAttributes } from './PartnerApiKeyCreateDataAttributes';
import {
    PartnerApiKeyCreateDataAttributesFromJSON,
    PartnerApiKeyCreateDataAttributesFromJSONTyped,
    PartnerApiKeyCreateDataAttributesToJSON,
    PartnerApiKeyCreateDataAttributesToJSONTyped,
} from './PartnerApiKeyCreateDataAttributes';

/**
 * 
 * @export
 * @interface PartnerApiKeyCreateData
 */
export interface PartnerApiKeyCreateData {
    /**
     * 
     * @type {string}
     * @memberof PartnerApiKeyCreateData
     */
    id?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {PartnerApiKeyCreateDataAttributes}
     * @memberof PartnerApiKeyCreateData
     */
    attributes?: PartnerApiKeyCreateDataAttributes;
}

/**
 * Check if a given object implements the PartnerApiKeyCreateData interface.
 */
export function instanceOfPartnerApiKeyCreateData(value: object): value is PartnerApiKeyCreateData {
    return true;
}

export function PartnerApiKeyCreateDataFromJSON(json: any): PartnerApiKeyCreateData {
    return PartnerApiKeyCreateDataFromJSONTyped(json, false);
}

export function PartnerApiKeyCreateDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): PartnerApiKeyCreateData {
    if (json == null) {
        return json;
    }
    return {
        ...
        'attributes': json['attributes'] == null ? undefined : PartnerApiKeyCreateDataAttributesFromJSON(json['attributes']),
    };
}

export function PartnerApiKeyCreateDataToJSON(json: any): PartnerApiKeyCreateData {
    return PartnerApiKeyCreateDataToJSONTyped(json, false);
}

export function PartnerApiKeyCreateDataToJSONTyped(value?: PartnerApiKeyCreateData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'id': value['id'],
        'type': value['type'],
        'attributes': PartnerApiKeyCreateDataAttributesToJSON(value['attributes']),
    };
}
