 ...
 * 
 * @export
 * @interface PartnerDiagnosticItem
 */
export interface PartnerDiagnosticItem {
    /**
     * 
     * @type {number}
     * @memberof PartnerDiagnosticItem
     */
...
/**
 * Check if a given object implements the PartnerDiagnosticItem interface.
 */
export function instanceOfPartnerDiagnosticItem(value: object): value is PartnerDiagnosticItem {
    if (!('diagnostic_id' in value) || value['diagnostic_id'] === undefined) return false;
    return true;
}

export function PartnerDiagnosticItemFromJSON(json: any): PartnerDiagnosticItem {
    return PartnerDiagnosticItemFromJSONTyped(json, false);
}

export function PartnerDiagnosticItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): PartnerDiagnosticItem {
    if (json == null) {
        return json;
    }
    return {
        ...
        'diagnostic_name': json['diagnostic_name'] == null ? undefined : json['diagnostic_name'],
        'price': json['price'] == null ? undefined : json['price'],
    };
}

export function PartnerDiagnosticItemToJSON(json: any): PartnerDiagnosticItem {
    return PartnerDiagnosticItemToJSONTyped(json, false);
}

export function PartnerDiagnosticItemToJSONTyped(value?: PartnerDiagnosticItem | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'diagnostic_name': value['diagnostic_name'],
        'price': value['price'],
    };
}
