...
import type { PartnerTransaction } from './PartnerTransaction';
import {
    PartnerTransactionFromJSON,
    PartnerTransactionFromJSONTyped,
    PartnerTransactionToJSON,
    PartnerTransactionToJSONTyped,
...
export function TransactionListFromJSONTyped(json: any, ignoreDiscriminator: boolean): TransactionList {
    ...
    return {
        ...
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(PartnerTransactionFromJSON)),
...
export function TransactionListToJSONTyped(value?: TransactionList | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(PartnerTransactionToJSON)),
