 ...
 * 
 * @export
 * @interface HomeCareOrder
 */
export interface HomeCareOrder {
    /**
     * 
     * @type {number}
     * @memberof HomeCareOrder
     */
    id?: number;
    /**
     * 
...
/**
 * Check if a given object implements the HomeCareOrder interface.
 */
export function instanceOfHomeCareOrder(value: object): value is HomeCareOrder {
    return true;
}

export function HomeCareOrderFromJSON(json: any): HomeCareOrder {
    return HomeCareOrderFromJSONTyped(json, false);
}

export function HomeCareOrderFromJSONTyped(json: any, ignoreDiscriminator: boolean): HomeCareOrder {
    if (json == null) {
        return json;
    }
    return {
...
export function HomeCareOrderToJSON(json: any): HomeCareOrder {
    return HomeCareOrderToJSONTyped(json, false);
}

export function HomeCareOrderToJSONTyped(value?: HomeCareOrder | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
