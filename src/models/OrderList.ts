 ...
 */
export function instanceOfOrderList(value: object): value is OrderList {
    return true;
}
...
export function OrderListToJSON(json: any): OrderList {
    return OrderListToJSONTyped(json, false);
}

export function OrderListToJSONTyped(value?: OrderList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
