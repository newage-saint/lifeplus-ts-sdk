 ...
 * 
 * @export
 * @interface MedicineGeneric
 */
export interface MedicineGeneric {
    /**
     * 
     * @type {number}
     * @memberof MedicineGeneric
     */
    id?: number;
    /**
     * 
...
/**
 * Check if a given object implements the MedicineGeneric interface.
 */
export function instanceOfMedicineGeneric(value: object): value is MedicineGeneric {
    return true;
}

export function MedicineGenericFromJSON(json: any): MedicineGeneric {
    return MedicineGenericFromJSONTyped(json, false);
}

export function MedicineGenericFromJSONTyped(json: any, ignoreDiscriminator: boolean): MedicineGeneric {
    if (json == null) {
        return json;
    }
    return {
...
export function MedicineGenericToJSON(json: any): MedicineGeneric {
    return MedicineGenericToJSONTyped(json, false);
}

export function MedicineGenericToJSONTyped(value?: MedicineGeneric | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
