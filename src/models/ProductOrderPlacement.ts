 ...
 * 
 * @export
 * @interface ProductOrderPlacement
 */
export interface ProductOrderPlacement {
    /**
     * 
     * @type {number}
     * @memberof ProductOrderPlacement
     */
    cart_id: number;
    /**
     * 
     ...
     * @memberof ProductOrderPlacement
     */
    payment_method: ProductOrderPlacementPaymentMethodEnum;
}
...
* @enum {string}
*/
export enum ProductOrderPlacementPaymentMethodEnum {
    Cod = 'cod',
    Online = 'online',
    Bkash = 'bkash',
    Nagad = 'nagad'
...
/**
 * Check if a given object implements the ProductOrderPlacement interface.
 */
export function instanceOfProductOrderPlacement(value: object): value is ProductOrderPlacement {
...
export function ProductOrderPlacementFromJSON(json: any): ProductOrderPlacement {
    return ProductOrderPlacementFromJSONTyped(json, false);
}

export function ProductOrderPlacementFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductOrderPlacement {
    if (json == null) {
        return json;
    }
    return {
...
export function ProductOrderPlacementToJSON(json: any): ProductOrderPlacement {
    return ProductOrderPlacementToJSONTyped(json, false);
}

export function ProductOrderPlacementToJSONTyped(value?: ProductOrderPlacement | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
