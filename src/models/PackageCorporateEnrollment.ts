...
/**
 * Request body for enrolling a user in a corporate package order
 * @export
 * @interface PackageCorporateEnrollment
 */
export interface PackageCorporateEnrollment {
    /**
     * 
     * @type {number}
     * @memberof PackageCorporateEnrollment
     */
    userId?: number;
    /**
     * 
...
/**
 * Check if a given object implements the PackageCorporateEnrollment interface.
 */
export function instanceOfPackageCorporateEnrollment(value: object): value is PackageCorporateEnrollment {
    return true;
}

export function PackageCorporateEnrollmentFromJSON(json: any): PackageCorporateEnrollment {
    return PackageCorporateEnrollmentFromJSONTyped(json, false);
}

export function PackageCorporateEnrollmentFromJSONTyped(json: any, ignoreDiscriminator: boolean): PackageCorporateEnrollment {
    if (json == null) {
        return json;
    }
    return {
...
export function PackageCorporateEnrollmentToJSON(json: any): PackageCorporateEnrollment {
    return PackageCorporateEnrollmentToJSONTyped(json, false);
}

export function PackageCorporateEnrollmentToJSONTyped(value?: PackageCorporateEnrollment | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
