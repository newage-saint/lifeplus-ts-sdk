 ...
 * 
 * @export
 * @interface WellbeingOrder
 */
export interface WellbeingOrder {
    /**
     * 
     * @type {number}
     * @memberof WellbeingOrder
     */
    id?: number;
    /**
     * 
...
/**
 * Check if a given object implements the WellbeingOrder interface.
 */
export function instanceOfWellbeingOrder(value: object): value is WellbeingOrder {
    return true;
}

export function WellbeingOrderFromJSON(json: any): WellbeingOrder {
    return WellbeingOrderFromJSONTyped(json, false);
}

export function WellbeingOrderFromJSONTyped(json: any, ignoreDiscriminator: boolean): WellbeingOrder {
    if (json == null) {
        return json;
    }
    return {
...
export function WellbeingOrderToJSON(json: any): WellbeingOrder {
    return WellbeingOrderToJSONTyped(json, false);
}

export function WellbeingOrderToJSONTyped(value?: WellbeingOrder | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
