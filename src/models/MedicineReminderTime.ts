...
/**
 * Update status of a medicine reminder time slot
 * @export
 * @interface MedicineReminderTime
 */
export interface MedicineReminderTime {
    /**
     * 
     * @type {string}
     * @memberof MedicineReminderTime
     */
    status?: MedicineReminderTimeStatusEnum;
    /**
     * 
     * @type {Date}
     * @memberof MedicineReminderTime
...
* @enum {string}
*/
export enum MedicineReminderTimeStatusEnum {
    Pending = 'pending',
    Taken = 'taken',
    Skipped = 'skipped',
    Missed = 'missed'
...
/**
 * Check if a given object implements the MedicineReminderTime interface.
 */
export function instanceOfMedicineReminderTime(value: object): value is MedicineReminderTime {
    return true;
}

export function MedicineReminderTimeFromJSON(json: any): MedicineReminderTime {
    return MedicineReminderTimeFromJSONTyped(json, false);
}

export function MedicineReminderTimeFromJSONTyped(json: any, ignoreDiscriminator: boolean): MedicineReminderTime {
    if (json == null) {
        return json;
    }
    return {
        ...
        'taken_at': json['taken_at'] == null ? undefined : (new Date(json['taken_at'])),
        'notes': json['notes'] == null ? undefined : json['notes'],
    };
}

export function MedicineReminderTimeToJSON(json: any): MedicineReminderTime {
    return MedicineReminderTimeToJSONTyped(json, false);
}

export function MedicineReminderTimeToJSONTyped(value?: MedicineReminderTime | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'status': value['status'],
        'taken_at': value['taken_at'] == null ? undefined : ((value['taken_at']).toISOString()),
        'notes': value['notes'],
    };
}
