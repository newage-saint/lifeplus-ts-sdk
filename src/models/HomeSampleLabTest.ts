 ...
 * 
 * @export
 * @interface HomeSampleLabTest
 */
export interface HomeSampleLabTest {
    /**
     * 
     * @type {number}
     * @memberof HomeSampleLabTest
     */
    id?: number;
    /**
     * 
...
/**
 * Check if a given object implements the HomeSampleLabTest interface.
 */
export function instanceOfHomeSampleLabTest(value: object): value is HomeSampleLabTest {
    return true;
}

export function HomeSampleLabTestFromJSON(json: any): HomeSampleLabTest {
    return HomeSampleLabTestFromJSONTyped(json, false);
}

export function HomeSampleLabTestFromJSONTyped(json: any, ignoreDiscriminator: boolean): HomeSampleLabTest {
    if (json == null) {
        return json;
    }
    return {
...
export function HomeSampleLabTestToJSON(json: any): HomeSampleLabTest {
    return HomeSampleLabTestToJSONTyped(json, false);
}

export function HomeSampleLabTestToJSONTyped(value?: HomeSampleLabTest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
