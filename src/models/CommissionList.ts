...
import type { CommissionListResponseSummary } from './CommissionListResponseSummary';
import {
    CommissionListResponseSummaryFromJSON,
    CommissionListResponseSummaryFromJSONTyped,
    CommissionListResponseSummaryToJSON,
    CommissionListResponseSummaryToJSONTyped,
} from './CommissionListResponseSummary';
...
export interface CommissionList {
    ...
    /**
     * 
     * @type {CommissionListResponseSummary}
     * @memberof CommissionList
     */
    summary?: CommissionListResponseSummary;
}

/**
 * Check if a given object implements the CommissionList interface.
 */
export function instanceOfCommissionList(value: object): value is CommissionList {
    return true;
}

export function CommissionListFromJSON(json: any): CommissionList {
    return CommissionListFromJSONTyped(json, false);
}

export function CommissionListFromJSONTyped(json: any, ignoreDiscriminator: boolean): CommissionList {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(CommissionFromJSON)),
        'pagination': json['pagination'] == null ? undefined : PaginationMetaFromJSON(json['pagination']),
        'summary': json['summary'] == null ? undefined : CommissionListResponseSummaryFromJSON(json['summary']),
    };
}

export function CommissionListToJSON(json: any): CommissionList {
    return CommissionListToJSONTyped(json, false);
}

export function CommissionListToJSONTyped(value?: CommissionList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(CommissionToJSON)),
        'pagination': PaginationMetaToJSON(value['pagination']),
        'summary': CommissionListResponseSummaryToJSON(value['summary']),
    };
}
