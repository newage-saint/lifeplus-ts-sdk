...
/**
 * Request body for updating a medicine reminder time status
 * @export
 * @interface MedicineReminderTimeStatusUpdate
 */
export interface MedicineReminderTimeStatusUpdate {
    /**
     * 
     * @type {string}
     * @memberof MedicineReminderTimeStatusUpdate
     */
    status?: MedicineReminderTimeStatusUpdateStatusEnum;
}
...
* @enum {string}
*/
export enum MedicineReminderTimeStatusUpdateStatusEnum {
    Taken = 'taken',
    Skipped = 'skipped',
    Pending = 'pending'
}
...
/**
 * Check if a given object implements the MedicineReminderTimeStatusUpdate interface.
 */
export function instanceOfMedicineReminderTimeStatusUpdate(value: object): value is MedicineReminderTimeStatusUpdate {
    return true;
}

export function MedicineReminderTimeStatusUpdateFromJSON(json: any): MedicineReminderTimeStatusUpdate {
    return MedicineReminderTimeStatusUpdateFromJSONTyped(json, false);
}

export function MedicineReminderTimeStatusUpdateFromJSONTyped(json: any, ignoreDiscriminator: boolean): MedicineReminderTimeStatusUpdate {
    if (json == null) {
        return json;
    }
    return {
...
export function MedicineReminderTimeStatusUpdateToJSON(json: any): MedicineReminderTimeStatusUpdate {
    return MedicineReminderTimeStatusUpdateToJSONTyped(json, false);
}

export function MedicineReminderTimeStatusUpdateToJSONTyped(value?: MedicineReminderTimeStatusUpdate | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
