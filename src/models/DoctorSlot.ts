...
/**
 * Check if a given object implements the DoctorSlot interface.
 */
export function instanceOfDoctorSlot(value: object): value is DoctorSlot {
    return true;
}

export function DoctorSlotFromJSON(json: any): DoctorSlot {
    return DoctorSlotFromJSONTyped(json, false);
}

export function DoctorSlotFromJSONTyped(json: any, ignoreDiscriminator: boolean): DoctorSlot {
    if (json == null) {
        return json;
    }
    return {
        
        'slot_id': json['slot_id'] == null ? undefined : json['slot_id'],
        'time_range': json['time_range'] == null ? undefined : json['time_range'],
        'is_available': json['is_available'] == null ? undefined : json['is_available'],
    };
}

export function DoctorSlotToJSON(json: any): DoctorSlot {
    return DoctorSlotToJSONTyped(json, false);
}

export function DoctorSlotToJSONTyped(value?: DoctorSlot | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
