...
/**
 * Check if a given object implements the PrescriptionUpload interface.
 */
export function instanceOfPrescriptionUpload(value: object): value is PrescriptionUpload {
    if (!('image' in value) || value['image'] === undefined) return false;
    if (!('userId' in value) || value['userId'] === undefined) return false;
    return true;
}

export function PrescriptionUploadFromJSON(json: any): PrescriptionUpload {
    return PrescriptionUploadFromJSONTyped(json, false);
}

export function PrescriptionUploadFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrescriptionUpload {
    if (json == null) {
        return json;
    }
    return {
...
export function PrescriptionUploadToJSON(json: any): PrescriptionUpload {
    return PrescriptionUploadToJSONTyped(json, false);
}

export function PrescriptionUploadToJSONTyped(value?: PrescriptionUpload | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
