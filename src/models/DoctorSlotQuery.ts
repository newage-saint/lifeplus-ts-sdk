 ...
 * 
 * @export
 * @interface DoctorSlotQuery
 */
export interface DoctorSlotQuery {
    /**
     * 
     * @type {number}
     * @memberof DoctorSlotQuery
     */
    doctor_id: number;
    /**
     * 
...
/**
 * Check if a given object implements the DoctorSlotQuery interface.
 */
export function instanceOfDoctorSlotQuery(value: object): value is DoctorSlotQuery {
    if (!('doctor_id' in value) || value['doctor_id'] === undefined) return false;
    if (!('telemedicine_date' in value) || value['telemedicine_date'] === undefined) return false;
    return true;
}

export function DoctorSlotQueryFromJSON(json: any): DoctorSlotQuery {
    return DoctorSlotQueryFromJSONTyped(json, false);
}

export function DoctorSlotQueryFromJSONTyped(json: any, ignoreDiscriminator: boolean): DoctorSlotQuery {
    if (json == null) {
        return json;
    }
    return {
        ...
        'telemedicine_date': (new Date(json['telemedicine_date'])),
        'available_slot': json['available_slot'] == null ? undefined : json['available_slot'],
        'telemedicine_day': json['telemedicine_day'] == null ? undefined : json['telemedicine_day'],
    };
}

export function DoctorSlotQueryToJSON(json: any): DoctorSlotQuery {
    return DoctorSlotQueryToJSONTyped(json, false);
}

export function DoctorSlotQueryToJSONTyped(value?: DoctorSlotQuery | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'telemedicine_date': ((value['telemedicine_date']).toISOString().substring(0,10)),
        'available_slot': value['available_slot'],
        'telemedicine_day': value['telemedicine_day'],
    };
}
