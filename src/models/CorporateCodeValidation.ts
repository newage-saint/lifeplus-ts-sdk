...
/**
 * Corporate code validation (request payload - noun-based DTO per IDEAL_MODELS.md)
 * @export
 * @interface CorporateCodeValidation
 */
export interface CorporateCodeValidation {
    /**
     * Corporate discount code to validate
     * @type {string}
     * @memberof CorporateCodeValidation
     */
    code: string;
    /**
...
/**
 * Check if a given object implements the CorporateCodeValidation interface.
 */
export function instanceOfCorporateCodeValidation(value: object): value is CorporateCodeValidation {
    if (!('code' in value) || value['code'] === undefined) return false;
    return true;
}

export function CorporateCodeValidationFromJSON(json: any): CorporateCodeValidation {
    return CorporateCodeValidationFromJSONTyped(json, false);
}

export function CorporateCodeValidationFromJSONTyped(json: any, ignoreDiscriminator: boolean): CorporateCodeValidation {
    if (json == null) {
        return json;
    }
    return {
...
export function CorporateCodeValidationToJSON(json: any): CorporateCodeValidation {
    return CorporateCodeValidationToJSONTyped(json, false);
}

export function CorporateCodeValidationToJSONTyped(value?: CorporateCodeValidation | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
