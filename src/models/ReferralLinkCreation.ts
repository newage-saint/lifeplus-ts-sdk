 ...
 * 
 * @export
 * @interface ReferralLinkCreation
 */
export interface ReferralLinkCreation {
    /**
     * Campaign identifier for tracking
     * @type {string}
     * @memberof ReferralLinkCreation
     */
    campaign?: string;
    /**
     ...
     * @memberof ReferralLinkCreation
     */
    service_type?: ReferralLinkCreationServiceTypeEnum;
    /**
...
* @enum {string}
*/
export enum ReferralLinkCreationServiceTypeEnum {
...
/**
 * Check if a given object implements the ReferralLinkCreation interface.
 */
export function instanceOfReferralLinkCreation(value: object): value is ReferralLinkCreation {
    return true;
}

export function ReferralLinkCreationFromJSON(json: any): ReferralLinkCreation {
    return ReferralLinkCreationFromJSONTyped(json, false);
}

export function ReferralLinkCreationFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReferralLinkCreation {
    if (json == null) {
        return json;
    }
    return {
        ...
        'custom_params': json['custom_params'] == null ? undefined : json['custom_params'],
    };
}

export function ReferralLinkCreationToJSON(json: any): ReferralLinkCreation {
    return ReferralLinkCreationToJSONTyped(json, false);
}

export function ReferralLinkCreationToJSONTyped(value?: ReferralLinkCreation | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'custom_params': value['custom_params'],
    };
}
