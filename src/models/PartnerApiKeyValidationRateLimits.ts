 ...
 * 
 * @export
 * @interface PartnerApiKeyValidationRateLimits
 */
export interface PartnerApiKeyValidationRateLimits {
    /**
     * Rate limit per minute
     * @type {number}
     * @memberof PartnerApiKeyValidationRateLimits
     */
    perMinute?: number;
    /**
     * Rate limit per hour
...
/**
 * Check if a given object implements the PartnerApiKeyValidationRateLimits interface.
 */
export function instanceOfPartnerApiKeyValidationRateLimits(value: object): value is PartnerApiKeyValidationRateLimits {
    return true;
}

export function PartnerApiKeyValidationRateLimitsFromJSON(json: any): PartnerApiKeyValidationRateLimits {
    return PartnerApiKeyValidationRateLimitsFromJSONTyped(json, false);
}

export function PartnerApiKeyValidationRateLimitsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PartnerApiKeyValidationRateLimits {
    if (json == null) {
        return json;
    }
    return {
        
        'perMinute': json['perMinute'] == null ? undefined : json['perMinute'],
        'perHour': json['perHour'] == null ? undefined : json['perHour'],
        'remainingMinute': json['remainingMinute'] == null ? undefined : json['remainingMinute'],
        'remainingHour': json['remainingHour'] == null ? undefined : json['remainingHour'],
    };
}

export function PartnerApiKeyValidationRateLimitsToJSON(json: any): PartnerApiKeyValidationRateLimits {
    return PartnerApiKeyValidationRateLimitsToJSONTyped(json, false);
}

export function PartnerApiKeyValidationRateLimitsToJSONTyped(value?: PartnerApiKeyValidationRateLimits | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'remainingMinute': value['remainingMinute'],
        'remainingHour': value['remainingHour'],
    };
}
