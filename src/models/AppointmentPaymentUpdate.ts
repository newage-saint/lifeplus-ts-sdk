 ...
 * @export
 * @interface AppointmentPaymentUpdate
 */
export interface AppointmentPaymentUpdate {
    /**
     * 
     * @type {string}
     * @memberof AppointmentPaymentUpdate
     */
    payment_method?: AppointmentPaymentUpdatePaymentMethodEnum;
    /**
     * 
     * @type {string}
     * @memberof AppointmentPaymentUpdate
     ...
     * @memberof AppointmentPaymentUpdate
     */
    payment_status?: AppointmentPaymentUpdatePaymentStatusEnum;
    /**
     * 
     * @type {number}
     * @memberof AppointmentPaymentUpdate
...
* @enum {string}
*/
export enum AppointmentPaymentUpdatePaymentMethodEnum {
    Cash = 'cash',
    Card = 'card',
    Online = 'online',
    Insurance = 'insurance'
...
* @enum {string}
*/
export enum AppointmentPaymentUpdatePaymentStatusEnum {
    Pending = 'pending',
    Paid = 'paid',
    Failed = 'failed'
}
...
/**
 * Check if a given object implements the AppointmentPaymentUpdate interface.
 */
export function instanceOfAppointmentPaymentUpdate(value: object): value is AppointmentPaymentUpdate {
    return true;
}

export function AppointmentPaymentUpdateFromJSON(json: any): AppointmentPaymentUpdate {
    return AppointmentPaymentUpdateFromJSONTyped(json, false);
}

export function AppointmentPaymentUpdateFromJSONTyped(json: any, ignoreDiscriminator: boolean): AppointmentPaymentUpdate {
    if (json == null) {
        return json;
    }
    return {
        ...
        'payment_status': json['payment_status'] == null ? undefined : json['payment_status'],
        'amount': json['amount'] == null ? undefined : json['amount'],
    };
}

export function AppointmentPaymentUpdateToJSON(json: any): AppointmentPaymentUpdate {
    return AppointmentPaymentUpdateToJSONTyped(json, false);
}

export function AppointmentPaymentUpdateToJSONTyped(value?: AppointmentPaymentUpdate | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
