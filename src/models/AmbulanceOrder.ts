 ...
 * 
 * @export
 * @interface AmbulanceOrder
 */
export interface AmbulanceOrder {
    /**
     * 
     * @type {number}
     * @memberof AmbulanceOrder
     */
    id?: number;
    /**
     * 
...
* @enum {string}
*/
export enum AmbulanceOrderTypeEnum {
    Icu = 'icu',
    NonIcu = 'non-icu',
    Freezer = 'freezer'
}
...
/**
 * Check if a given object implements the AmbulanceOrder interface.
 */
export function instanceOfAmbulanceOrder(value: object): value is AmbulanceOrder {
    return true;
}

export function AmbulanceOrderFromJSON(json: any): AmbulanceOrder {
    return AmbulanceOrderFromJSONTyped(json, false);
}

export function AmbulanceOrderFromJSONTyped(json: any, ignoreDiscriminator: boolean): AmbulanceOrder {
    if (json == null) {
        return json;
    }
    return {
...
export function AmbulanceOrderToJSON(json: any): AmbulanceOrder {
    return AmbulanceOrderToJSONTyped(json, false);
}

export function AmbulanceOrderToJSONTyped(value?: AmbulanceOrder | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
