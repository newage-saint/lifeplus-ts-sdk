...
import type { PartnerApiKey } from './PartnerApiKey';
import {
    PartnerApiKeyFromJSON,
    PartnerApiKeyFromJSONTyped,
    PartnerApiKeyToJSON,
    PartnerApiKeyToJSONTyped,
} from './PartnerApiKey';
import type { PartnerApiKeyListMeta } from './PartnerApiKeyListMeta';
import {
    PartnerApiKeyListMetaFromJSON,
    PartnerApiKeyListMetaFromJSONTyped,
    PartnerApiKeyListMetaToJSON,
    PartnerApiKeyListMetaToJSONTyped,
} from './PartnerApiKeyListMeta';

/**
 * 
 * @export
 * @interface PartnerApiKeyList
 */
export interface PartnerApiKeyList {
    /**
     * 
     * @type {Array<PartnerApiKey>}
     * @memberof PartnerApiKeyList
     */
    data?: Array<PartnerApiKey>;
    /**
     * 
     * @type {PartnerApiKeyListMeta}
     * @memberof PartnerApiKeyList
     */
...
/**
 * Check if a given object implements the PartnerApiKeyList interface.
 */
export function instanceOfPartnerApiKeyList(value: object): value is PartnerApiKeyList {
    return true;
}

export function PartnerApiKeyListFromJSON(json: any): PartnerApiKeyList {
    return PartnerApiKeyListFromJSONTyped(json, false);
}

export function PartnerApiKeyListFromJSONTyped(json: any, ignoreDiscriminator: boolean): PartnerApiKeyList {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(PartnerApiKeyFromJSON)),
        'meta': json['meta'] == null ? undefined : PartnerApiKeyListMetaFromJSON(json['meta']),
    };
}

export function PartnerApiKeyListToJSON(json: any): PartnerApiKeyList {
    return PartnerApiKeyListToJSONTyped(json, false);
}

export function PartnerApiKeyListToJSONTyped(value?: PartnerApiKeyList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(PartnerApiKeyToJSON)),
        'meta': PartnerApiKeyListMetaToJSON(value['meta']),
    };
}
