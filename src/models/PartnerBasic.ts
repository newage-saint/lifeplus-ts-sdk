...
* @enum {string}
*/
export enum PartnerBasicStatusEnum {
    Active = 'active',
    Inactive = 'inactive',
    Suspended = 'suspended'
}
...
/**
 * Check if a given object implements the PartnerBasic interface.
 */
export function instanceOfPartnerBasic(value: object): value is PartnerBasic {
    return true;
}

export function PartnerBasicFromJSON(json: any): PartnerBasic {
    return PartnerBasicFromJSONTyped(json, false);
}

export function PartnerBasicFromJSONTyped(json: any, ignoreDiscriminator: boolean): PartnerBasic {
    if (json == null) {
        return json;
    }
    return {
...
export function PartnerBasicToJSON(json: any): PartnerBasic {
    return PartnerBasicToJSONTyped(json, false);
}

export function PartnerBasicToJSONTyped(value?: PartnerBasic | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
