...
/**
 * Check if a given object implements the LifestyleCategory interface.
 */
export function instanceOfLifestyleCategory(value: object): value is LifestyleCategory {
    return true;
}

export function LifestyleCategoryFromJSON(json: any): LifestyleCategory {
    return LifestyleCategoryFromJSONTyped(json, false);
}

export function LifestyleCategoryFromJSONTyped(json: any, ignoreDiscriminator: boolean): LifestyleCategory {
    if (json == null) {
        return json;
    }
    return {
...
export function LifestyleCategoryToJSON(json: any): LifestyleCategory {
    return LifestyleCategoryToJSONTyped(json, false);
}

export function LifestyleCategoryToJSONTyped(value?: LifestyleCategory | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
