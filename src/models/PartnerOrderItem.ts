...
/**
 * Check if a given object implements the PartnerOrderItem interface.
 */
export function instanceOfPartnerOrderItem(value: object): value is PartnerOrderItem {
    if (!('product_id' in value) || value['product_id'] === undefined) return false;
    if (!('quantity' in value) || value['quantity'] === undefined) return false;
    return true;
}

export function PartnerOrderItemFromJSON(json: any): PartnerOrderItem {
    return PartnerOrderItemFromJSONTyped(json, false);
}

export function PartnerOrderItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): PartnerOrderItem {
    if (json == null) {
        return json;
    }
    return {
        ...
        'product_variant_id': json['product_variant_id'] == null ? undefined : json['product_variant_id'],
        'price': json['price'] == null ? undefined : json['price'],
    };
}

export function PartnerOrderItemToJSON(json: any): PartnerOrderItem {
    return PartnerOrderItemToJSONTyped(json, false);
}

export function PartnerOrderItemToJSONTyped(value?: PartnerOrderItem | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
