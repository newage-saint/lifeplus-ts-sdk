 ...
 * 
 * @export
 * @interface CommissionListResponseSummary
 */
export interface CommissionListResponseSummary {
    /**
     * 
     * @type {number}
     * @memberof CommissionListResponseSummary
     */
...
/**
 * Check if a given object implements the CommissionListResponseSummary interface.
 */
export function instanceOfCommissionListResponseSummary(value: object): value is CommissionListResponseSummary {
    return true;
}

export function CommissionListResponseSummaryFromJSON(json: any): CommissionListResponseSummary {
    return CommissionListResponseSummaryFromJSONTyped(json, false);
}

export function CommissionListResponseSummaryFromJSONTyped(json: any, ignoreDiscriminator: boolean): CommissionListResponseSummary {
    if (json == null) {
        return json;
    }
    return {
        
        'total_commission': json['total_commission'] == null ? undefined : json['total_commission'],
...
export function CommissionListResponseSummaryToJSON(json: any): CommissionListResponseSummary {
    return CommissionListResponseSummaryToJSONTyped(json, false);
}

export function CommissionListResponseSummaryToJSONTyped(value?: CommissionListResponseSummary | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
