...
export interface AmbulanceBooking {
     ...
     * 
     * @type {string}
     * @memberof AmbulanceBooking
     */
    type: AmbulanceBookingTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof AmbulanceBooking
...
* @enum {string}
*/
export enum AmbulanceBookingTypeEnum {
    Icu = 'icu',
    NonIcu = 'non-icu',
    Freezer = 'freezer'
}
...
/**
 * Check if a given object implements the AmbulanceBooking interface.
 */
export function instanceOfAmbulanceBooking(value: object): value is AmbulanceBooking {
    if (!('type' in value) || value['type'] === undefined) return false;
    if (!('pickup_point' in value) || value['pickup_point'] === undefined) return false;
    if (!('destination_point' in value) || value['destination_point'] === undefined) return false;
    return true;
}

export function AmbulanceBookingFromJSON(json: any): AmbulanceBooking {
    return AmbulanceBookingFromJSONTyped(json, false);
}

export function AmbulanceBookingFromJSONTyped(json: any, ignoreDiscriminator: boolean): AmbulanceBooking {
    if (json == null) {
        return json;
    }
    return {
        ...
        'destination_point': json['destination_point'],
    };
}

export function AmbulanceBookingToJSON(json: any): AmbulanceBooking {
    return AmbulanceBookingToJSONTyped(json, false);
}

export function AmbulanceBookingToJSONTyped(value?: AmbulanceBooking | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
