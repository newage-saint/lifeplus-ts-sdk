...
export interface ApiKeyCreation {
     ...
     * @memberof ApiKeyCreation
     */
    environment: ApiKeyCreationEnvironmentEnum;
    /**
     * 
...
* @enum {string}
*/
export enum ApiKeyCreationEnvironmentEnum {
    Live = 'live',
    Test = 'test'
}
...
/**
 * Check if a given object implements the ApiKeyCreation interface.
 */
export function instanceOfApiKeyCreation(value: object): value is ApiKeyCreation {
...
export function ApiKeyCreationFromJSON(json: any): ApiKeyCreation {
    return ApiKeyCreationFromJSONTyped(json, false);
}

export function ApiKeyCreationFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiKeyCreation {
    if (json == null) {
        return json;
    }
    return {
        ...
        'permissions': PartnerApiKeyPermissionsFromJSON(json['permissions']),
...
export function ApiKeyCreationToJSON(json: any): ApiKeyCreation {
    return ApiKeyCreationToJSONTyped(json, false);
}

export function ApiKeyCreationToJSONTyped(value?: ApiKeyCreation | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
