...
import type { PartnerApiKeyCreateData } from './PartnerApiKeyCreateData';
import {
    PartnerApiKeyCreateDataFromJSON,
    PartnerApiKeyCreateDataFromJSONTyped,
    PartnerApiKeyCreateDataToJSON,
    PartnerApiKeyCreateDataToJSONTyped,
} from './PartnerApiKeyCreateData';
import type { PartnerApiKeyCreateMeta } from './PartnerApiKeyCreateMeta';
import {
    PartnerApiKeyCreateMetaFromJSON,
    PartnerApiKeyCreateMetaFromJSONTyped,
    PartnerApiKeyCreateMetaToJSON,
    PartnerApiKeyCreateMetaToJSONTyped,
} from './PartnerApiKeyCreateMeta';

/**
 * 
 * @export
 * @interface PartnerApiKeyCreation
 */
export interface PartnerApiKeyCreation {
    /**
     * 
     * @type {PartnerApiKeyCreateData}
     * @memberof PartnerApiKeyCreation
     */
    data?: PartnerApiKeyCreateData;
    /**
     * 
     * @type {PartnerApiKeyCreateMeta}
     * @memberof PartnerApiKeyCreation
     */
    meta?: PartnerApiKeyCreateMeta;
}

/**
 * Check if a given object implements the PartnerApiKeyCreation interface.
 */
export function instanceOfPartnerApiKeyCreation(value: object): value is PartnerApiKeyCreation {
    return true;
}

export function PartnerApiKeyCreationFromJSON(json: any): PartnerApiKeyCreation {
    return PartnerApiKeyCreationFromJSONTyped(json, false);
}

export function PartnerApiKeyCreationFromJSONTyped(json: any, ignoreDiscriminator: boolean): PartnerApiKeyCreation {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : PartnerApiKeyCreateDataFromJSON(json['data']),
        'meta': json['meta'] == null ? undefined : PartnerApiKeyCreateMetaFromJSON(json['meta']),
    };
}

export function PartnerApiKeyCreationToJSON(json: any): PartnerApiKeyCreation {
    return PartnerApiKeyCreationToJSONTyped(json, false);
}

export function PartnerApiKeyCreationToJSONTyped(value?: PartnerApiKeyCreation | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': PartnerApiKeyCreateDataToJSON(value['data']),
        'meta': PartnerApiKeyCreateMetaToJSON(value['meta']),
    };
}
