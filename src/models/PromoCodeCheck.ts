...
/**
 * Promo code validation (request payload - noun-based DTO per IDEAL_MODELS.md)
 * @export
 * @interface PromoCodeCheck
 */
export interface PromoCodeCheck {
    /**
     * Promo code to validate
     * @type {string}
     * @memberof PromoCodeCheck
     */
    code: string;
    /**
     ...
     * @memberof PromoCodeCheck
     */
    readonly discountType?: PromoCodeCheckDiscountTypeEnum;
    /**
     * Validation message
     * @type {string}
     * @memberof PromoCodeCheck
...
* @enum {string}
*/
export enum PromoCodeCheckDiscountTypeEnum {
...
/**
 * Check if a given object implements the PromoCodeCheck interface.
 */
export function instanceOfPromoCodeCheck(value: object): value is PromoCodeCheck {
    if (!('code' in value) || value['code'] === undefined) return false;
    if (!('order_amount' in value) || value['order_amount'] === undefined) return false;
    return true;
}

export function PromoCodeCheckFromJSON(json: any): PromoCodeCheck {
    return PromoCodeCheckFromJSONTyped(json, false);
}

export function PromoCodeCheckFromJSONTyped(json: any, ignoreDiscriminator: boolean): PromoCodeCheck {
    if (json == null) {
        return json;
    }
    return {
...
export function PromoCodeCheckToJSON(json: any): PromoCodeCheck {
    return PromoCodeCheckToJSONTyped(json, false);
}

export function PromoCodeCheckToJSONTyped(value?: Omit<PromoCodeCheck, 'valid'|'discount'|'discountType'|'message'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
