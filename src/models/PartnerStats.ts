...
export function PartnerStatsToJSON(json: any): PartnerStats {
    return PartnerStatsToJSONTyped(json, false);
}

export function PartnerStatsToJSONTyped(value?: PartnerStats | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
