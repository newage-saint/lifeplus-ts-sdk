 ...
 * 
 * @export
 * @interface DiagnosticCreation
 */
export interface DiagnosticCreation {
    /**
     * 
     * @type {string}
     * @memberof DiagnosticCreation
     */
    name: string;
    /**
     * 
...
/**
 * Check if a given object implements the DiagnosticCreation interface.
 */
export function instanceOfDiagnosticCreation(value: object): value is DiagnosticCreation {
    if (!('name' in value) || value['name'] === undefined) return false;
    return true;
}

export function DiagnosticCreationFromJSON(json: any): DiagnosticCreation {
    return DiagnosticCreationFromJSONTyped(json, false);
}

export function DiagnosticCreationFromJSONTyped(json: any, ignoreDiscriminator: boolean): DiagnosticCreation {
    if (json == null) {
        return json;
    }
    return {
...
export function DiagnosticCreationToJSON(json: any): DiagnosticCreation {
    return DiagnosticCreationToJSONTyped(json, false);
}

export function DiagnosticCreationToJSONTyped(value?: DiagnosticCreation | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
