...
/**
 * Remaining service counts for package
 * @export
 * @interface UserPackageStatusRemainingServices
 */
export interface UserPackageStatusRemainingServices {
    /**
     * 
     * @type {number}
     * @memberof UserPackageStatusRemainingServices
     */
...
/**
 * Check if a given object implements the UserPackageStatusRemainingServices interface.
 */
export function instanceOfUserPackageStatusRemainingServices(value: object): value is UserPackageStatusRemainingServices {
    return true;
}

export function UserPackageStatusRemainingServicesFromJSON(json: any): UserPackageStatusRemainingServices {
    return UserPackageStatusRemainingServicesFromJSONTyped(json, false);
}

export function UserPackageStatusRemainingServicesFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserPackageStatusRemainingServices {
    if (json == null) {
        return json;
    }
    return {
        
        'consultations': json['consultations'] == null ? undefined : json['consultations'],
        'diagnosticTests': json['diagnosticTests'] == null ? undefined : json['diagnosticTests'],
        'medicines': json['medicines'] == null ? undefined : json['medicines'],
    };
}

export function UserPackageStatusRemainingServicesToJSON(json: any): UserPackageStatusRemainingServices {
    return UserPackageStatusRemainingServicesToJSONTyped(json, false);
}

export function UserPackageStatusRemainingServicesToJSONTyped(value?: UserPackageStatusRemainingServices | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'diagnosticTests': value['diagnosticTests'],
