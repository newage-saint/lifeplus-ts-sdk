...
/**
 * Check if a given object implements the AvatarUpload interface.
 */
export function instanceOfAvatarUpload(value: object): value is AvatarUpload {
    return true;
}

export function AvatarUploadFromJSON(json: any): AvatarUpload {
    return AvatarUploadFromJSONTyped(json, false);
}

export function AvatarUploadFromJSONTyped(json: any, ignoreDiscriminator: boolean): AvatarUpload {
    if (json == null) {
        return json;
    }
    return {
...
export function AvatarUploadToJSON(json: any): AvatarUpload {
    return AvatarUploadToJSONTyped(json, false);
}

export function AvatarUploadToJSONTyped(value?: AvatarUpload | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
