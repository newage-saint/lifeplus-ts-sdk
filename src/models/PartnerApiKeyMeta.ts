...
/**
 * Check if a given object implements the PartnerApiKeyMeta interface.
 */
export function instanceOfPartnerApiKeyMeta(value: object): value is PartnerApiKeyMeta {
    return true;
}

export function PartnerApiKeyMetaFromJSON(json: any): PartnerApiKeyMeta {
    return PartnerApiKeyMetaFromJSONTyped(json, false);
}

export function PartnerApiKeyMetaFromJSONTyped(json: any, ignoreDiscriminator: boolean): PartnerApiKeyMeta {
    if (json == null) {
        return json;
    }
    return {
...
export function PartnerApiKeyMetaToJSON(json: any): PartnerApiKeyMeta {
    return PartnerApiKeyMetaToJSONTyped(json, false);
}

export function PartnerApiKeyMetaToJSONTyped(value?: PartnerApiKeyMeta | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
