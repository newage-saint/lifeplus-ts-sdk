 ...
 * 
 * @export
 * @interface PartnerDeliveryAddress
 */
export interface PartnerDeliveryAddress {
    /**
     * 
     * @type {string}
     * @memberof PartnerDeliveryAddress
     */
    address: string;
    /**
     * 
...
/**
 * Check if a given object implements the PartnerDeliveryAddress interface.
 */
export function instanceOfPartnerDeliveryAddress(value: object): value is PartnerDeliveryAddress {
    if (!('address' in value) || value['address'] === undefined) return false;
    if (!('city' in value) || value['city'] === undefined) return false;
    return true;
}

export function PartnerDeliveryAddressFromJSON(json: any): PartnerDeliveryAddress {
    return PartnerDeliveryAddressFromJSONTyped(json, false);
}

export function PartnerDeliveryAddressFromJSONTyped(json: any, ignoreDiscriminator: boolean): PartnerDeliveryAddress {
    if (json == null) {
        return json;
    }
    return {
...
export function PartnerDeliveryAddressToJSON(json: any): PartnerDeliveryAddress {
    return PartnerDeliveryAddressToJSONTyped(json, false);
}

export function PartnerDeliveryAddressToJSONTyped(value?: PartnerDeliveryAddress | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
