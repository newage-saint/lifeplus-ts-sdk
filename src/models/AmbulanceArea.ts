 ...
 * 
 * @export
 * @interface AmbulanceArea
 */
export interface AmbulanceArea {
    /**
     * 
     * @type {number}
     * @memberof AmbulanceArea
     */
    id?: number;
    /**
     * 
...
/**
 * Check if a given object implements the AmbulanceArea interface.
 */
export function instanceOfAmbulanceArea(value: object): value is AmbulanceArea {
    return true;
}

export function AmbulanceAreaFromJSON(json: any): AmbulanceArea {
    return AmbulanceAreaFromJSONTyped(json, false);
}

export function AmbulanceAreaFromJSONTyped(json: any, ignoreDiscriminator: boolean): AmbulanceArea {
    if (json == null) {
        return json;
    }
    return {
...
export function AmbulanceAreaToJSON(json: any): AmbulanceArea {
    return AmbulanceAreaToJSONTyped(json, false);
}

export function AmbulanceAreaToJSONTyped(value?: AmbulanceArea | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
