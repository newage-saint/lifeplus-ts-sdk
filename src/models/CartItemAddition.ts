...
/**
 * Check if a given object implements the CartItemAddition interface.
 */
export function instanceOfCartItemAddition(value: object): value is CartItemAddition {
    if (!('product_id' in value) || value['product_id'] === undefined) return false;
    if (!('quantity' in value) || value['quantity'] === undefined) return false;
    return true;
}

export function CartItemAdditionFromJSON(json: any): CartItemAddition {
    return CartItemAdditionFromJSONTyped(json, false);
}

export function CartItemAdditionFromJSONTyped(json: any, ignoreDiscriminator: boolean): CartItemAddition {
    if (json == null) {
        return json;
    }
    return {
...
export function CartItemAdditionToJSON(json: any): CartItemAddition {
    return CartItemAdditionToJSONTyped(json, false);
}

export function CartItemAdditionToJSONTyped(value?: CartItemAddition | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
