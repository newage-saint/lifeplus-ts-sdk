 ...
 * 
 * @export
 * @interface PartnerApiKeyListMeta
 */
export interface PartnerApiKeyListMeta {
    /**
     * 
     * @type {string}
     * @memberof PartnerApiKeyListMeta
     */
    requestId?: string;
    /**
     * 
...
/**
 * Check if a given object implements the PartnerApiKeyListMeta interface.
 */
export function instanceOfPartnerApiKeyListMeta(value: object): value is PartnerApiKeyListMeta {
    return true;
}

export function PartnerApiKeyListMetaFromJSON(json: any): PartnerApiKeyListMeta {
    return PartnerApiKeyListMetaFromJSONTyped(json, false);
}

export function PartnerApiKeyListMetaFromJSONTyped(json: any, ignoreDiscriminator: boolean): PartnerApiKeyListMeta {
    if (json == null) {
        return json;
    }
    return {
...
export function PartnerApiKeyListMetaToJSON(json: any): PartnerApiKeyListMeta {
    return PartnerApiKeyListMetaToJSONTyped(json, false);
}

export function PartnerApiKeyListMetaToJSONTyped(value?: PartnerApiKeyListMeta | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
