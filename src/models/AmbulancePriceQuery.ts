 ...
 * 
 * @export
 * @interface AmbulancePriceQuery
 */
export interface AmbulancePriceQuery {
    /**
     * 
     * @type {string}
     * @memberof AmbulancePriceQuery
     */
    type?: AmbulancePriceQueryTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof AmbulancePriceQuery
...
* @enum {string}
*/
export enum AmbulancePriceQueryTypeEnum {
    Icu = 'icu',
    NonIcu = 'non-icu',
    Freezer = 'freezer'
}
...
/**
 * Check if a given object implements the AmbulancePriceQuery interface.
 */
export function instanceOfAmbulancePriceQuery(value: object): value is AmbulancePriceQuery {
    return true;
}

export function AmbulancePriceQueryFromJSON(json: any): AmbulancePriceQuery {
    return AmbulancePriceQueryFromJSONTyped(json, false);
}

export function AmbulancePriceQueryFromJSONTyped(json: any, ignoreDiscriminator: boolean): AmbulancePriceQuery {
    if (json == null) {
        return json;
    }
    return {
        ...
        'pickup_point': json['pickup_point'] == null ? undefined : json['pickup_point'],
        'destination_point': json['destination_point'] == null ? undefined : json['destination_point'],
        'price': json['price'] == null ? undefined : json['price'],
        'currency': json['currency'] == null ? undefined : json['currency'],
    };
}

export function AmbulancePriceQueryToJSON(json: any): AmbulancePriceQuery {
    return AmbulancePriceQueryToJSONTyped(json, false);
}

export function AmbulancePriceQueryToJSONTyped(value?: Omit<AmbulancePriceQuery, 'price'|'currency'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'destination_point': value['destination_point'],
    };
}
