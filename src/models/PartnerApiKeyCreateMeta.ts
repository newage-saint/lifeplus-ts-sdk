 ...
 * 
 * @export
 * @interface PartnerApiKeyCreateMeta
 */
export interface PartnerApiKeyCreateMeta {
    /**
     * 
     * @type {string}
     * @memberof PartnerApiKeyCreateMeta
     */
    requestId?: string;
    /**
     * 
...
/**
 * Check if a given object implements the PartnerApiKeyCreateMeta interface.
 */
export function instanceOfPartnerApiKeyCreateMeta(value: object): value is PartnerApiKeyCreateMeta {
    return true;
}

export function PartnerApiKeyCreateMetaFromJSON(json: any): PartnerApiKeyCreateMeta {
    return PartnerApiKeyCreateMetaFromJSONTyped(json, false);
}

export function PartnerApiKeyCreateMetaFromJSONTyped(json: any, ignoreDiscriminator: boolean): PartnerApiKeyCreateMeta {
    if (json == null) {
        return json;
    }
    return {
...
export function PartnerApiKeyCreateMetaToJSON(json: any): PartnerApiKeyCreateMeta {
    return PartnerApiKeyCreateMetaToJSONTyped(json, false);
}

export function PartnerApiKeyCreateMetaToJSONTyped(value?: PartnerApiKeyCreateMeta | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
