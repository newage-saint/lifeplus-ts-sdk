...
export interface PartnerTransaction {
     ...
     * @memberof PartnerTransaction
     */
    event_type?: PartnerTransactionEventTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof PartnerTransaction
...
* @enum {string}
*/
export enum PartnerTransactionEventTypeEnum {
    Click = 'click',
    PageView = 'page_view',
...
/**
 * Check if a given object implements the PartnerTransaction interface.
 */
export function instanceOfPartnerTransaction(value: object): value is PartnerTransaction {
    return true;
}

export function PartnerTransactionFromJSON(json: any): PartnerTransaction {
    return PartnerTransactionFromJSONTyped(json, false);
}

export function PartnerTransactionFromJSONTyped(json: any, ignoreDiscriminator: boolean): PartnerTransaction {
    if (json == null) {
        return json;
    }
    return {
        ...
        'event_data': json['event_data'] == null ? undefined : json['event_data'],
...
export function PartnerTransactionToJSON(json: any): PartnerTransaction {
    return PartnerTransactionToJSONTyped(json, false);
}

export function PartnerTransactionToJSONTyped(value?: PartnerTransaction | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
