 ...
 * 
 * @export
 * @interface PartnerAnalyticsPeriod
 */
export interface PartnerAnalyticsPeriod {
    /**
     * 
     * @type {Date}
     * @memberof PartnerAnalyticsPeriod
     */
    start?: Date;
    /**
     * 
...
/**
 * Check if a given object implements the PartnerAnalyticsPeriod interface.
 */
export function instanceOfPartnerAnalyticsPeriod(value: object): value is PartnerAnalyticsPeriod {
    return true;
}

export function PartnerAnalyticsPeriodFromJSON(json: any): PartnerAnalyticsPeriod {
    return PartnerAnalyticsPeriodFromJSONTyped(json, false);
}

export function PartnerAnalyticsPeriodFromJSONTyped(json: any, ignoreDiscriminator: boolean): PartnerAnalyticsPeriod {
    if (json == null) {
        return json;
    }
    return {
...
export function PartnerAnalyticsPeriodToJSON(json: any): PartnerAnalyticsPeriod {
    return PartnerAnalyticsPeriodToJSONTyped(json, false);
}

export function PartnerAnalyticsPeriodToJSONTyped(value?: PartnerAnalyticsPeriod | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
