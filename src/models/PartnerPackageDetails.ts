 ...
 */
export interface PartnerPackageDetails {
    /**
     * 
     * @type {number}
     * @memberof PartnerPackageDetails
     */
    package_id: number;
    /**
     * 
     ...
     * @memberof PartnerPackageDetails
     */
    health_card_delivery_address?: PartnerDeliveryAddress;
}

/**
 * Check if a given object implements the PartnerPackageDetails interface.
 */
export function instanceOfPartnerPackageDetails(value: object): value is PartnerPackageDetails {
    if (!('package_id' in value) || value['package_id'] === undefined) return false;
    return true;
}

export function PartnerPackageDetailsFromJSON(json: any): PartnerPackageDetails {
    return PartnerPackageDetailsFromJSONTyped(json, false);
}

export function PartnerPackageDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PartnerPackageDetails {
    if (json == null) {
        return json;
    }
    return {
        ...
        'health_card_required': json['health_card_required'] == null ? undefined : json['health_card_required'],
        'health_card_delivery_address': json['health_card_delivery_address'] == null ? undefined : PartnerDeliveryAddressFromJSON(json['health_card_delivery_address']),
    };
}

export function PartnerPackageDetailsToJSON(json: any): PartnerPackageDetails {
    return PartnerPackageDetailsToJSONTyped(json, false);
}

export function PartnerPackageDetailsToJSONTyped(value?: PartnerPackageDetails | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'health_card_required': value['health_card_required'],
        'health_card_delivery_address': PartnerDeliveryAddressToJSON(value['health_card_delivery_address']),
    };
}
