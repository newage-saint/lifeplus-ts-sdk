...
export interface PackageBooking {
     ...
     * 
     * @type {number}
     * @memberof PackageBooking
     */
    package_id: number;
}

/**
 * Check if a given object implements the PackageBooking interface.
 */
export function instanceOfPackageBooking(value: object): value is PackageBooking {
    if (!('package_id' in value) || value['package_id'] === undefined) return false;
    return true;
}

export function PackageBookingFromJSON(json: any): PackageBooking {
    return PackageBookingFromJSONTyped(json, false);
}

export function PackageBookingFromJSONTyped(json: any, ignoreDiscriminator: boolean): PackageBooking {
    if (json == null) {
        return json;
    }
    return {
...
export function PackageBookingToJSON(json: any): PackageBooking {
    return PackageBookingToJSONTyped(json, false);
}

export function PackageBookingToJSONTyped(value?: PackageBooking | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
