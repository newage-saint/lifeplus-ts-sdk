...
import type { HotlineRequest } from './HotlineRequest';
import {
    HotlineRequestFromJSON,
    HotlineRequestFromJSONTyped,
    HotlineRequestToJSON,
    HotlineRequestToJSONTyped,
} from './HotlineRequest';

/**
 * Hotline request list response with pagination
 * @export
 * @interface HotlineRequestList
 */
export interface HotlineRequestList {
    /**
     * 
     * @type {Array<HotlineRequest>}
     * @memberof HotlineRequestList
     */
    data?: Array<HotlineRequest>;
    /**
     * 
     * @type {PaginationMeta}
     * @memberof HotlineRequestList
...
/**
 * Check if a given object implements the HotlineRequestList interface.
 */
export function instanceOfHotlineRequestList(value: object): value is HotlineRequestList {
    return true;
}

export function HotlineRequestListFromJSON(json: any): HotlineRequestList {
    return HotlineRequestListFromJSONTyped(json, false);
}

export function HotlineRequestListFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotlineRequestList {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(HotlineRequestFromJSON)),
        'meta': json['meta'] == null ? undefined : PaginationMetaFromJSON(json['meta']),
    };
}

export function HotlineRequestListToJSON(json: any): HotlineRequestList {
    return HotlineRequestListToJSONTyped(json, false);
}

export function HotlineRequestListToJSONTyped(value?: HotlineRequestList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(HotlineRequestToJSON)),
