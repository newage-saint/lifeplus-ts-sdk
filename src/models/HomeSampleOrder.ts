 ...
 * 
 * @export
 * @interface HomeSampleOrder
 */
export interface HomeSampleOrder {
    /**
     * 
     * @type {number}
     * @memberof HomeSampleOrder
     */
    id?: number;
    /**
     * 
...
/**
 * Check if a given object implements the HomeSampleOrder interface.
 */
export function instanceOfHomeSampleOrder(value: object): value is HomeSampleOrder {
    return true;
}

export function HomeSampleOrderFromJSON(json: any): HomeSampleOrder {
    return HomeSampleOrderFromJSONTyped(json, false);
}

export function HomeSampleOrderFromJSONTyped(json: any, ignoreDiscriminator: boolean): HomeSampleOrder {
    if (json == null) {
        return json;
    }
    return {
        ...
        'diagnostics_ids': json['diagnostics_ids'] == null ? undefined : json['diagnostics_ids'],
        ...
        'home_sample': json['home_sample'] == null ? undefined : json['home_sample'],
        'status': json['status'] == null ? undefined : json['status'],
    };
}

export function HomeSampleOrderToJSON(json: any): HomeSampleOrder {
    return HomeSampleOrderToJSONTyped(json, false);
}

export function HomeSampleOrderToJSONTyped(value?: HomeSampleOrder | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'diagnostics_ids': value['diagnostics_ids'],
        'myself': value['myself'],
        'name': value['name'],
