...
import type { PartnerBasic } from './PartnerBasic';
import {
    PartnerBasicFromJSON,
    PartnerBasicFromJSONTyped,
    PartnerBasicToJSON,
    PartnerBasicToJSONTyped,
} from './PartnerBasic';
...
/**
 * Check if a given object implements the PartnerLogin interface.
 */
export function instanceOfPartnerLogin(value: object): value is PartnerLogin {
    if (!('api_key' in value) || value['api_key'] === undefined) return false;
    return true;
}

export function PartnerLoginFromJSON(json: any): PartnerLogin {
    return PartnerLoginFromJSONTyped(json, false);
}

export function PartnerLoginFromJSONTyped(json: any, ignoreDiscriminator: boolean): PartnerLogin {
    if (json == null) {
        return json;
    }
    return {
        ...
        'partner': json['partner'] == null ? undefined : PartnerBasicFromJSON(json['partner']),
    };
}

export function PartnerLoginToJSON(json: any): PartnerLogin {
    return PartnerLoginToJSONTyped(json, false);
}

export function PartnerLoginToJSONTyped(value?: Omit<PartnerLogin, 'access_token'|'token_type'|'expires_in'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'partner': PartnerBasicToJSON(value['partner']),
    };
}
