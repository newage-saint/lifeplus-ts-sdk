 ...
 */
export function instanceOfHospital(value: object): value is Hospital {
    return true;
}
...
export function HospitalToJSON(json: any): Hospital {
    return HospitalToJSONTyped(json, false);
}

export function HospitalToJSONTyped(value?: Hospital | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
