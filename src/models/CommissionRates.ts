...
/**
 * Check if a given object implements the CommissionRates interface.
 */
export function instanceOfCommissionRates(value: object): value is CommissionRates {
    return true;
}

export function CommissionRatesFromJSON(json: any): CommissionRates {
    return CommissionRatesFromJSONTyped(json, false);
}

export function CommissionRatesFromJSONTyped(json: any, ignoreDiscriminator: boolean): CommissionRates {
    if (json == null) {
        return json;
    }
    return {
...
export function CommissionRatesToJSON(json: any): CommissionRates {
    return CommissionRatesToJSONTyped(json, false);
}

export function CommissionRatesToJSONTyped(value?: CommissionRates | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
