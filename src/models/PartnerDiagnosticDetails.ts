...
import type { PartnerDiagnosticItem } from './PartnerDiagnosticItem';
import {
    PartnerDiagnosticItemFromJSON,
    PartnerDiagnosticItemFromJSONTyped,
    PartnerDiagnosticItemToJSON,
    PartnerDiagnosticItemToJSONTyped,
} from './PartnerDiagnosticItem';

/**
 * 
 * @export
 * @interface PartnerDiagnosticDetails
 */
export interface PartnerDiagnosticDetails {
    /**
     * 
     * @type {Array<PartnerDiagnosticItem>}
     * @memberof PartnerDiagnosticDetails
     */
    diagnostic_items: Array<PartnerDiagnosticItem>;
    /**
     * 
     * @type {number}
     * @memberof PartnerDiagnosticDetails
...
/**
 * Check if a given object implements the PartnerDiagnosticDetails interface.
 */
export function instanceOfPartnerDiagnosticDetails(value: object): value is PartnerDiagnosticDetails {
    if (!('diagnostic_items' in value) || value['diagnostic_items'] === undefined) return false;
    return true;
}

export function PartnerDiagnosticDetailsFromJSON(json: any): PartnerDiagnosticDetails {
    return PartnerDiagnosticDetailsFromJSONTyped(json, false);
}

export function PartnerDiagnosticDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PartnerDiagnosticDetails {
    if (json == null) {
        return json;
    }
    return {
        
        'diagnostic_items': ((json['diagnostic_items'] as Array<any>).map(PartnerDiagnosticItemFromJSON)),
        'hospital_id': json['hospital_id'] == null ? undefined : json['hospital_id'],
        'preferred_date': json['preferred_date'] == null ? undefined : (new Date(json['preferred_date'])),
        'preferred_time': json['preferred_time'] == null ? undefined : json['preferred_time'],
        'home_sample_collection': json['home_sample_collection'] == null ? undefined : json['home_sample_collection'],
        'notes': json['notes'] == null ? undefined : json['notes'],
    };
}

export function PartnerDiagnosticDetailsToJSON(json: any): PartnerDiagnosticDetails {
    return PartnerDiagnosticDetailsToJSONTyped(json, false);
}

export function PartnerDiagnosticDetailsToJSONTyped(value?: PartnerDiagnosticDetails | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'diagnostic_items': ((value['diagnostic_items'] as Array<any>).map(PartnerDiagnosticItemToJSON)),
        'hospital_id': value['hospital_id'],
        'preferred_date': value['preferred_date'] == null ? undefined : ((value['preferred_date']).toISOString().substring(0,10)),
        'preferred_time': value['preferred_time'],
        'home_sample_collection': value['home_sample_collection'],
        'notes': value['notes'],
    };
}
