 ...
 * 
 * @export
 * @interface PartnerApiKeyValidationRestrictions
 */
export interface PartnerApiKeyValidationRestrictions {
    /**
     * Allowed IP addresses
     * @type {Array<string>}
     * @memberof PartnerApiKeyValidationRestrictions
     */
...
/**
 * Check if a given object implements the PartnerApiKeyValidationRestrictions interface.
 */
export function instanceOfPartnerApiKeyValidationRestrictions(value: object): value is PartnerApiKeyValidationRestrictions {
    return true;
}

export function PartnerApiKeyValidationRestrictionsFromJSON(json: any): PartnerApiKeyValidationRestrictions {
    return PartnerApiKeyValidationRestrictionsFromJSONTyped(json, false);
}

export function PartnerApiKeyValidationRestrictionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PartnerApiKeyValidationRestrictions {
    if (json == null) {
        return json;
    }
    return {
...
export function PartnerApiKeyValidationRestrictionsToJSON(json: any): PartnerApiKeyValidationRestrictions {
    return PartnerApiKeyValidationRestrictionsToJSONTyped(json, false);
}

export function PartnerApiKeyValidationRestrictionsToJSONTyped(value?: PartnerApiKeyValidationRestrictions | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
