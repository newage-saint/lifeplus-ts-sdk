...
/**
 * Check if a given object implements the PhoneVerification interface.
 */
export function instanceOfPhoneVerification(value: object): value is PhoneVerification {
    return true;
}

export function PhoneVerificationFromJSON(json: any): PhoneVerification {
    return PhoneVerificationFromJSONTyped(json, false);
}

export function PhoneVerificationFromJSONTyped(json: any, ignoreDiscriminator: boolean): PhoneVerification {
    if (json == null) {
        return json;
    }
    return {
...
export function PhoneVerificationToJSON(json: any): PhoneVerification {
    return PhoneVerificationToJSONTyped(json, false);
}

export function PhoneVerificationToJSONTyped(value?: PhoneVerification | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
