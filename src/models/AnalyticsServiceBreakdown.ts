 ...
 * 
 * @export
 * @interface AnalyticsServiceBreakdown
 */
export interface AnalyticsServiceBreakdown {
    /**
     * 
     * @type {string}
     * @memberof AnalyticsServiceBreakdown
     */
    service_type?: string;
    /**
     * 
...
/**
 * Check if a given object implements the AnalyticsServiceBreakdown interface.
 */
export function instanceOfAnalyticsServiceBreakdown(value: object): value is AnalyticsServiceBreakdown {
    return true;
}

export function AnalyticsServiceBreakdownFromJSON(json: any): AnalyticsServiceBreakdown {
    return AnalyticsServiceBreakdownFromJSONTyped(json, false);
}

export function AnalyticsServiceBreakdownFromJSONTyped(json: any, ignoreDiscriminator: boolean): AnalyticsServiceBreakdown {
    if (json == null) {
        return json;
    }
    return {
...
export function AnalyticsServiceBreakdownToJSON(json: any): AnalyticsServiceBreakdown {
    return AnalyticsServiceBreakdownToJSONTyped(json, false);
}

export function AnalyticsServiceBreakdownToJSONTyped(value?: AnalyticsServiceBreakdown | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
