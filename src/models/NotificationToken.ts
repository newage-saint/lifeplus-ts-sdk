...
/**
 * Request body for saving an FCM notification token
 * @export
...
export interface NotificationToken {
     ...
     * @memberof NotificationToken
     */
    platform?: NotificationTokenPlatformEnum;
}
...
* @enum {string}
*/
export enum NotificationTokenPlatformEnum {
    Ios = 'ios',
    Android = 'android',
    Web = 'web'
}
...
/**
 * Check if a given object implements the NotificationToken interface.
 */
export function instanceOfNotificationToken(value: object): value is NotificationToken {
    return true;
}

export function NotificationTokenFromJSON(json: any): NotificationToken {
    return NotificationTokenFromJSONTyped(json, false);
}

export function NotificationTokenFromJSONTyped(json: any, ignoreDiscriminator: boolean): NotificationToken {
    if (json == null) {
        return json;
    }
    return {
...
export function NotificationTokenToJSON(json: any): NotificationToken {
    return NotificationTokenToJSONTyped(json, false);
}

export function NotificationTokenToJSONTyped(value?: NotificationToken | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
