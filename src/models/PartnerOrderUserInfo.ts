 ...
 * 
 * @export
 * @interface PartnerOrderUserInfo
 */
export interface PartnerOrderUserInfo {
    /**
     * 
     * @type {string}
     * @memberof PartnerOrderUserInfo
     */
    name: string;
    /**
     * 
     ...
     * @memberof PartnerOrderUserInfo
     */
    gender?: PartnerOrderUserInfoGenderEnum;
}
...
* @enum {string}
*/
export enum PartnerOrderUserInfoGenderEnum {
    Male = 'male',
    Female = 'female',
    Other = 'other'
}
...
/**
 * Check if a given object implements the PartnerOrderUserInfo interface.
 */
export function instanceOfPartnerOrderUserInfo(value: object): value is PartnerOrderUserInfo {
    if (!('name' in value) || value['name'] === undefined) return false;
    if (!('mobile' in value) || value['mobile'] === undefined) return false;
    return true;
}

export function PartnerOrderUserInfoFromJSON(json: any): PartnerOrderUserInfo {
    return PartnerOrderUserInfoFromJSONTyped(json, false);
}

export function PartnerOrderUserInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): PartnerOrderUserInfo {
    if (json == null) {
        return json;
    }
    return {
...
export function PartnerOrderUserInfoToJSON(json: any): PartnerOrderUserInfo {
    return PartnerOrderUserInfoToJSONTyped(json, false);
}

export function PartnerOrderUserInfoToJSONTyped(value?: PartnerOrderUserInfo | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
