...
export interface DiagnosticList {
     ...
     * @memberof DiagnosticList
     */
    data?: Array<Diagnostic>;
}

/**
 * Check if a given object implements the DiagnosticList interface.
 */
export function instanceOfDiagnosticList(value: object): value is DiagnosticList {
    return true;
}

export function DiagnosticListFromJSON(json: any): DiagnosticList {
    return DiagnosticListFromJSONTyped(json, false);
}

export function DiagnosticListFromJSONTyped(json: any, ignoreDiscriminator: boolean): DiagnosticList {
    if (json == null) {
        return json;
    }
    return {
        
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(DiagnosticFromJSON)),
    };
}

export function DiagnosticListToJSON(json: any): DiagnosticList {
    return DiagnosticListToJSONTyped(json, false);
}

export function DiagnosticListToJSONTyped(value?: DiagnosticList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(DiagnosticToJSON)),
    };
}
