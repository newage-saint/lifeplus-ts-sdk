 ...
 * @export
 * @interface PartnerApiKeyPermissions
 */
export interface PartnerApiKeyPermissions {
    /**
     * 
     * @type {Array<string>}
     * @memberof PartnerApiKeyPermissions
     */
    orders?: Array<PartnerApiKeyPermissionsOrdersEnum>;
    /**
     * 
     * @type {Array<string>}
     * @memberof PartnerApiKeyPermissions
     */
    products?: Array<PartnerApiKeyPermissionsProductsEnum>;
    /**
     * 
     * @type {Array<string>}
     * @memberof PartnerApiKeyPermissions
     */
    customers?: Array<PartnerApiKeyPermissionsCustomersEnum>;
    /**
     * 
     * @type {Array<string>}
     * @memberof PartnerApiKeyPermissions
     */
    packages?: Array<PartnerApiKeyPermissionsPackagesEnum>;
    /**
     * 
     * @type {Array<string>}
     * @memberof PartnerApiKeyPermissions
     */
    appointments?: Array<PartnerApiKeyPermissionsAppointmentsEnum>;
}
...
* @enum {string}
*/
export enum PartnerApiKeyPermissionsOrdersEnum {
    Read = 'read',
    Create = 'create',
    Update = 'update',
    Delete = 'delete'
...
* @enum {string}
*/
export enum PartnerApiKeyPermissionsProductsEnum {
    Read = 'read'
}
/**
* @export
* @enum {string}
*/
export enum PartnerApiKeyPermissionsCustomersEnum {
    Read = 'read',
    Create = 'create',
    Update = 'update'
}
...
* @enum {string}
*/
export enum PartnerApiKeyPermissionsPackagesEnum {
    Read = 'read',
    Create = 'create',
    Update = 'update'
}
...
* @enum {string}
*/
export enum PartnerApiKeyPermissionsAppointmentsEnum {
    Read = 'read',
    Create = 'create',
    Update = 'update',
    Delete = 'delete'
...
/**
 * Check if a given object implements the PartnerApiKeyPermissions interface.
 */
export function instanceOfPartnerApiKeyPermissions(value: object): value is PartnerApiKeyPermissions {
    return true;
}

export function PartnerApiKeyPermissionsFromJSON(json: any): PartnerApiKeyPermissions {
    return PartnerApiKeyPermissionsFromJSONTyped(json, false);
}

export function PartnerApiKeyPermissionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PartnerApiKeyPermissions {
    if (json == null) {
        return json;
    }
    return {
...
export function PartnerApiKeyPermissionsToJSON(json: any): PartnerApiKeyPermissions {
    return PartnerApiKeyPermissionsToJSONTyped(json, false);
}

export function PartnerApiKeyPermissionsToJSONTyped(value?: PartnerApiKeyPermissions | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
