...
import {
    ...
    ManufacturerToJSON,
    MedicineGenericFromJSON,
    MedicineGenericToJSON,
    SpecialtyFromJSON,
    SpecialtyToJSON,
} from '../models/index';
...
export interface LookupApiInterface {
     ...
     */
    getCountriesRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<Country>>>;

    /**
     * List all countries
     * Get countries
     */
    getCountries(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Country>>;

    /**
     * List all generic medicine names
     * @summary Get generics
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof LookupApiInterface
     */
    getGenericsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<MedicineGeneric>>>;

    /**
     * List all generic medicine names
     * Get generics
     */
    getGenerics(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<MedicineGeneric>>;
     ...
     * @memberof LookupApiInterface
     */
    getManufacturersRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<Manufacturer>>>;

    /**
     * List all pharmaceutical manufacturers
     * Get manufacturers
     */
    getManufacturers(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Manufacturer>>;
     ...
     * @memberof LookupApiInterface
     */
    getSpecialtiesRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<Specialty>>>;

    /**
     * List all medical specialties
     * Get specialties
     */
    getSpecialties(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Specialty>>;
...
export class LookupApi extends runtime.BaseAPI implements LookupApiInterface {
     ...
     * Get countries
     */
    async getCountriesRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<Country>>> {
     ...
     * Get countries
     */
    async getCountries(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Country>> {
     ...
     * Get generics
     */
    async getGenericsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<MedicineGeneric>>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(MedicineGenericFromJSON));
    }
     ...
     * Get generics
     */
    async getGenerics(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<MedicineGeneric>> {
        const response = await this.getGenericsRaw(initOverrides);
        return await response.value();
    }
     ...
     * Get manufacturers
     */
    async getManufacturersRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<Manufacturer>>> {
        const queryParameters: any = {};
     ...
     * Get manufacturers
     */
    async getManufacturers(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Manufacturer>> {
     ...
     * Get specialties
     */
    async getSpecialtiesRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<Specialty>>> {
        const queryParameters: any = {};
     ...
     * Get specialties
     */
    async getSpecialties(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Specialty>> {
        const response = await this.getSpecialtiesRaw(initOverrides);
        return await response.value();
    }
