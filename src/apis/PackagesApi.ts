...
import {
    PackageFromJSON,
    PackageToJSON,
    PackageBookingFromJSON,
    PackageBookingToJSON,
...
export interface PackagesApiInterface {
     ...
     */
    bookPackageRaw(requestParameters: BookPackageRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SuccessResponse>>;

    /**
     * Book a wellness or homecare package
     * Book a package
     */
    bookPackage(requestParameters: BookPackageRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SuccessResponse>;

    /**
     * List available packages (wellness, homecare)
     * @summary List packages
     * @param {number} [type] 8&#x3D;wellness, 13&#x3D;homecare
     ...
     * @memberof PackagesApiInterface
     */
    listPackagesRaw(requestParameters: ListPackagesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<Package>>>;

    /**
     * List available packages (wellness, homecare)
     * List packages
     */
    listPackages(requestParameters: ListPackagesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Package>>;
...
export class PackagesApi extends runtime.BaseAPI implements PackagesApiInterface {
     ...
     * Book a package
     */
    async bookPackageRaw(requestParameters: BookPackageRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SuccessResponse>> {
        if (requestParameters['packageBooking'] == null) {
            throw new runtime.RequiredError(
                'packageBooking',
                'Required parameter "packageBooking" was null or undefined when calling bookPackage().'
            );
        }
        ...
        const response = await this.request({
            ...
            body: PackageBookingToJSON(requestParameters['packageBooking']),
        }, initOverrides);
     ...
     * Book a package
     */
    async bookPackage(requestParameters: BookPackageRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SuccessResponse> {
        const response = await this.bookPackageRaw(requestParameters, initOverrides);
     ...
     * List packages
     */
    async listPackagesRaw(requestParameters: ListPackagesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<Package>>> {
        const queryParameters: any = {};
     ...
     * List packages
     */
    async listPackages(requestParameters: ListPackagesRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Package>> {
