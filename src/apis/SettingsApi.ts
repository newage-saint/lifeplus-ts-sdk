...
export interface SettingsApiInterface {
    /**
     * 
     * @summary Get delivery charge information
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof SettingsApiInterface
     */
    deliveryChargesGetRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>>;

    /**
     * Get delivery charge information
     */
    deliveryChargesGet(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void>;

    /**
     * 
     * @summary Get app settings and configuration
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof SettingsApiInterface
     */
    settingsGetRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>>;

    /**
     * Get app settings and configuration
     */
    settingsGet(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void>;

    /**
     * 
     * @summary Get app slider/banner images
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof SettingsApiInterface
     */
    sliderImagesGetRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>>;

    /**
     * Get app slider/banner images
     */
    sliderImagesGet(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void>;
...
export class SettingsApi extends runtime.BaseAPI implements SettingsApiInterface {
     ...
     * Get delivery charge information
     */
    async deliveryChargesGetRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
     ...
     * Get delivery charge information
     */
    async deliveryChargesGet(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.deliveryChargesGetRaw(initOverrides);
    }

    /**
     * Get app settings and configuration
     */
    async settingsGetRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const queryParameters: any = {};
     ...
     * Get app settings and configuration
     */
    async settingsGet(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.settingsGetRaw(initOverrides);
    }

    /**
     * Get app slider/banner images
     */
    async sliderImagesGetRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const queryParameters: any = {};
     ...
     * Get app slider/banner images
     */
    async sliderImagesGet(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.sliderImagesGetRaw(initOverrides);
    }
