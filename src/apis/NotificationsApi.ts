...
import {
    NotificationTokenFromJSON,
    NotificationTokenToJSON,
} from '../models/index';
...
export interface NotificationsPostRequest {
...
export interface NotificationsApiInterface {
     ...
     */
    notificationsGetRaw(requestParameters: NotificationsGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>>;

    /**
     * Get user notifications
     */
    notificationsGet(requestParameters: NotificationsGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void>;

    /**
     * 
     * @summary Save notification token (FCM)
     * @param {NotificationToken} notificationToken 
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof NotificationsApiInterface
     */
    notificationsPostRaw(requestParameters: NotificationsPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>>;

    /**
     * Save notification token (FCM)
     */
    notificationsPost(requestParameters: NotificationsPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void>;
...
export class NotificationsApi extends runtime.BaseAPI implements NotificationsApiInterface {
     ...
     * Get user notifications
     */
    async notificationsGetRaw(requestParameters: NotificationsGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['userId'] == null) {
            throw new runtime.RequiredError(
                'userId',
                'Required parameter "userId" was null or undefined when calling notificationsGet().'
            );
        }
     ...
     * Get user notifications
     */
    async notificationsGet(requestParameters: NotificationsGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.notificationsGetRaw(requestParameters, initOverrides);
    }

    /**
     * Save notification token (FCM)
     */
    async notificationsPostRaw(requestParameters: NotificationsPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['notificationToken'] == null) {
            throw new runtime.RequiredError(
                'notificationToken',
                'Required parameter "notificationToken" was null or undefined when calling notificationsPost().'
            );
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: NotificationTokenToJSON(requestParameters['notificationToken']),
        }, initOverrides);
     ...
     * Save notification token (FCM)
     */
    async notificationsPost(requestParameters: NotificationsPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.notificationsPostRaw(requestParameters, initOverrides);
    }
