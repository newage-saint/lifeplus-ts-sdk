...
export interface PoliciesIdDeleteRequest {
    id: number;
}

export interface PoliciesIdGetRequest {
    id: number;
}

export interface PoliciesIdPutRequest {
    id: number;
}
 ...
 * 
 * @export
 * @interface PoliciesApiInterface
 */
export interface PoliciesApiInterface {
     ...
     */
    policiesGetRaw(requestParameters: PoliciesGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>>;

    /**
     * List insurance policies
     */
    policiesGet(requestParameters: PoliciesGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void>;
     ...
     * @memberof PoliciesApiInterface
     */
    policiesIdDeleteRaw(requestParameters: PoliciesIdDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>>;

    /**
     * Delete policy
     */
    policiesIdDelete(requestParameters: PoliciesIdDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void>;
     ...
     * @memberof PoliciesApiInterface
     */
    policiesIdGetRaw(requestParameters: PoliciesIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>>;

    /**
     * Get policy details
     */
    policiesIdGet(requestParameters: PoliciesIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void>;
     ...
     * @memberof PoliciesApiInterface
     */
    policiesIdPutRaw(requestParameters: PoliciesIdPutRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>>;

    /**
     * Update policy
     */
    policiesIdPut(requestParameters: PoliciesIdPutRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void>;
     ...
     * @memberof PoliciesApiInterface
     */
    policiesPostRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>>;

    /**
     * Create policy
     */
    policiesPost(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void>;
     ...
     * @memberof PoliciesApiInterface
     */
    policyCategoriesGetRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>>;

    /**
     * List policy categories
     */
    policyCategoriesGet(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void>;
 ...
 * 
 */
export class PoliciesApi extends runtime.BaseAPI implements PoliciesApiInterface {

    /**
     * List insurance policies
     */
    async policiesGetRaw(requestParameters: PoliciesGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
     ...
     * List insurance policies
     */
    async policiesGet(requestParameters: PoliciesGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.policiesGetRaw(requestParameters, initOverrides);
    }

    /**
     * Delete policy
     */
    async policiesIdDeleteRaw(requestParameters: PoliciesIdDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling policiesIdDelete().'
            );
        }
     ...
     * Delete policy
     */
    async policiesIdDelete(requestParameters: PoliciesIdDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.policiesIdDeleteRaw(requestParameters, initOverrides);
    }

    /**
     * Get policy details
     */
    async policiesIdGetRaw(requestParameters: PoliciesIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling policiesIdGet().'
            );
        }
     ...
     * Get policy details
     */
    async policiesIdGet(requestParameters: PoliciesIdGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.policiesIdGetRaw(requestParameters, initOverrides);
    }

    /**
     * Update policy
     */
    async policiesIdPutRaw(requestParameters: PoliciesIdPutRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling policiesIdPut().'
            );
        }
     ...
     * Update policy
     */
    async policiesIdPut(requestParameters: PoliciesIdPutRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.policiesIdPutRaw(requestParameters, initOverrides);
    }

    /**
     * Create policy
     */
    async policiesPostRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const queryParameters: any = {};
     ...
     * Create policy
     */
    async policiesPost(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.policiesPostRaw(initOverrides);
    }

    /**
     * List policy categories
     */
    async policyCategoriesGetRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const queryParameters: any = {};
     ...
     * List policy categories
     */
    async policyCategoriesGet(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.policyCategoriesGetRaw(initOverrides);
    }
