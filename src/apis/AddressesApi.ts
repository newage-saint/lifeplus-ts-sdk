...
export interface AddressesApiInterface {
     ...
     */
    createAddressRaw(requestParameters: CreateAddressRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Address>>;

    /**
     * Add a new address for the current user
     * Create address
     */
    createAddress(requestParameters: CreateAddressRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Address>;
     ...
     * @memberof AddressesApiInterface
     */
    deleteAddressRaw(requestParameters: DeleteAddressRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>>;

    /**
     * Remove an address
     * Delete address
     */
    deleteAddress(requestParameters: DeleteAddressRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void>;
     ...
     * @memberof AddressesApiInterface
     */
    listAddressesRaw(requestParameters: ListAddressesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<Address>>>;

    /**
     * Retrieve all addresses for the current user
     * List addresses
     */
    listAddresses(requestParameters: ListAddressesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Address>>;
     ...
     * @memberof AddressesApiInterface
     */
    updateAddressRaw(requestParameters: UpdateAddressRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Address>>;

    /**
     * Edit an existing address
     * Update address
     */
    updateAddress(requestParameters: UpdateAddressRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Address>;
...
export class AddressesApi extends runtime.BaseAPI implements AddressesApiInterface {
     ...
     * Create address
     */
    async createAddressRaw(requestParameters: CreateAddressRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Address>> {
        if (requestParameters['address'] == null) {
            throw new runtime.RequiredError(
                'address',
                'Required parameter "address" was null or undefined when calling createAddress().'
            );
        }
     ...
     * Create address
     */
    async createAddress(requestParameters: CreateAddressRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Address> {
    ...
    async deleteAddressRaw(requestParameters: DeleteAddressRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling deleteAddress().'
            );
        }
     ...
     * List addresses
     */
    async listAddressesRaw(requestParameters: ListAddressesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<Address>>> {
        const queryParameters: any = {};
     ...
     * List addresses
     */
    async listAddresses(requestParameters: ListAddressesRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Address>> {
     ...
     * Update address
     */
    async updateAddressRaw(requestParameters: UpdateAddressRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Address>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling updateAddress().'
            );
        }
        ...
        if (requestParameters['address'] == null) {
            throw new runtime.RequiredError(
                'address',
                'Required parameter "address" was null or undefined when calling updateAddress().'
            );
        }
     ...
     * Update address
     */
    async updateAddress(requestParameters: UpdateAddressRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Address> {
