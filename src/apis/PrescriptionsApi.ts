...
export interface PrescriptionsPostRequest {
    image: Blob;
    userId: number;
}
 ...
 * 
 * @export
 * @interface PrescriptionsApiInterface
 */
export interface PrescriptionsApiInterface {
     ...
     */
    prescriptionsPostRaw(requestParameters: PrescriptionsPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>>;

    /**
     * Upload prescription image
     */
    prescriptionsPost(requestParameters: PrescriptionsPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void>;
 ...
 * 
 */
export class PrescriptionsApi extends runtime.BaseAPI implements PrescriptionsApiInterface {

    /**
     * Upload prescription image
     */
    async prescriptionsPostRaw(requestParameters: PrescriptionsPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['image'] == null) {
            throw new runtime.RequiredError(
                'image',
                'Required parameter "image" was null or undefined when calling prescriptionsPost().'
            );
        }
        ...
        if (requestParameters['userId'] == null) {
            throw new runtime.RequiredError(
                'userId',
                'Required parameter "userId" was null or undefined when calling prescriptionsPost().'
            );
        }
     ...
     * Upload prescription image
     */
    async prescriptionsPost(requestParameters: PrescriptionsPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.prescriptionsPostRaw(requestParameters, initOverrides);
    }
